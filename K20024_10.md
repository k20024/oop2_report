...
バージョン管理システムは、だれが、いつ、なんのために行ったのかをすぐに共有でき、複数の開発者が効率的に開発ができ、ソースコードの紛失を防げ、簡単に以前のバージョンを再現でき、開発ツールによるサポートが受けられるという様々なメリットがある。

参考文献
株式会社オープングルーヴ、"バージョン管理とは"、https://tracpath.com/feature_scm-html/、(閲覧日　2021年12月15日)

### 3-2. Gitにおけるキーワード「clone」「commit」「push」「branch」「fetch」「pull」「merge」「rebase」についてそれぞれ何をするものか (他者に説明できるよう、わかりやすく簡潔な文章で表すこと)

「clone」
既存のGitリポジトリのコピーを取得したい場合に使用する。
リポジトリとは、何か協力したいと思っているプロジェクトなどのことを言う。
参考文献
git-scm.com,"2.1 Git の基本 - Git リポジトリの取得",https://git-scm.com/book/ja/v2/Git-%E3%81%AE%E5%9F%BA%E6%9C%AC-Git-%E3%83%AA%E3%83%9D%E3%82%B8%E3%83%88%E3%83%AA%E3%81%AE%E5%8F%96%E5%BE%97 (閲覧日　2021年12月15日)
