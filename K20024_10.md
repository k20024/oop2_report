...
「commit」
ファイルやディレクトリの追加・変更を、リポジトリに記録する場合に使用する。
参考文献
Backlog,"Gitの基本 変更を記録するコミット",https://backlog.com/ja/git-tutorial/intro/03/ (閲覧日　2021年12月15日)

「push」
ローカルの変更を中央リポジトリに公開、アップロードするとき使用する。
参考文献
ATLASSIAN Bitbucket、"Git のプッシュ",https://www.atlassian.com/ja/git/tutorials/syncing/git-push#:~:text=git%20push%20%E3%81%AF%E3%80%81%E3%83%AD%E3%83%BC%E3%82%AB%E3%83%AB%E3%81%AE,%E3%83%A1%E3%83%B3%E3%83%90%E3%83%BC%E3%81%A8%E5%85%B1%E6%9C%89%E3%81%A7%E3%81%8D%E3%81%BE%E3%81%99%E3%80%82, (閲覧日　2021年12月15日)

「branch」
ブランチの作成、一覧表示、名称変更、削除を行う際に使用される。
ブランチとは、履歴の流れを分岐して記録していくためのものである。
参考文献
Backlog、"ブランチ ブランチとは",https://backlog.com/ja/git-tutorial/stepup/01/ (閲覧日　2021年12月15日)
ATLASSIAN Bitbucket,"Git Branch コマンド",https://www.atlassian.com/ja/git/tutorials/using-branches#:~:text=git%20branch%20%E3%81%AF%E3%80%81%E3%83%96%E3%83%A9%E3%83%B3%E3%83%81%E3%81%AE,%E3%81%AB%E6%88%BB%E3%81%99%E6%A9%9F%E8%83%BD%E3%82%82%E3%81%82%E3%82%8A%E3%81%BE%E3%81%9B%E3%82%93%E3%80%82  (閲覧日　2021年12月15日)

「fetch」
リモート リポジトリからローカル リポジトリにコミット、ファイル、参照をダウンロードする。
参考文献
ATLASSIAN Bitbucket、"git fetch",https://www.atlassian.com/ja/git/tutorials/syncing/git-fetch (閲覧日　2021年12月15日)

「pull」
リモート リポジトリからコンテンツをフェッチしてダウンロードし、そのコンテンツと一致するようローカル リポジトリを即時に更新するために使用される。
参考文献
ATLASSIAN Bitbucket,"git pull",https://www.atlassian.com/ja/git/tutorials/syncing/git-pull (閲覧日　2021年12月15日)
「merge」
Gitにおいて分岐した履歴を戻して統合する際に使用される。
参考文献
ATLASSIAN Bitbucket、"Git merge",https://www.atlassian.com/ja/git/tutorials/using-branches/git-merge (閲覧日　2021年12月15日)
「rebase」
1 つのブランチから別のブランチへの変更を統合する際に使用される。
参考文献
ATLASSIAN Bitbucket、"Git rebase",https://www.atlassian.com/ja/git/tutorials/rewriting-history/git-rebase (閲覧日　2021年12月15日)
### 3-3. プロジェクト進行に、GitHub Flowを採用することで解決できるチーム開発での問題はなにか (実際にGitHub Flowで作業する手順も説明する)
ブランチ名を気にしなくても良いので共通認識がないメンバー同士でも開発がスムーズに行える。


1 開発リポジトリを、自分のアカウントへforkする
2 masterブランチから、作業ブランチを切り替える
...
Qiita,"GitHub Flowとは",https://qiita.com/tatane616/items/aec00cdc1b659761cf88 (閲覧日　2021年12月15日)
